...
private void Atualizar(Scanner menu) {
	...
	try {
		...
		while (true) {
			...
			System.out.print("\n\nAtualizar:\n");
	        System.out.print("Op��o 1 - Dados do Professor \n");
	        System.out.print("Op��o 2 - Endere�o do professor\n");
	        System.out.print("Op��o 3 - Disciplinas do professor\n");
	        System.out.print("Op��o 4 - Retornar \n\n");
	        System.out.print("Digite uma op��o: ");
...
private Professor ObtemProfessorSelecionado(Scanner menu) {
	...
	try {
		...
		if(numeroElementos == 0) {
			System.out.print("Nenhuma professor dispon�vies.\n"
		...
		for (Object professorDB : listaProfessores) {
			...
			System.out.print("Op��o: " + indiceLista + " - Nome: " + ((Professor)professorDB).getNome() + "\n");
		}
